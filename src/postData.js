export const postData = [
    {
        ...
        language: {
            English: {       
                ...
                content: "This blog is nothing special, just a fun project, and maybe I'll keep posting from time to time on it, my thoughts and so on. But until then, have a great day! -Mok"
            },
            German: {       
